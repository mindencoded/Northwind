...
{
    [RoutePrefix("PurchaseOrderStatus.svc")]
    [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
    public class PurchaseOrderStatusService :
        CommandService<IBusinessUnitOfWork, PurchaseOrderStatus, PurchaseOrderStatusDto>, IPurchaseOrderStatusService
    {
        public PurchaseOrderStatusService(IUnityContainer container) : base(container)
        {
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "PurchaseOrderStatus.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "PurchaseOrderStatus.Insert")]
        public override void Insert(PurchaseOrderStatusDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "PurchaseOrderStatus.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "PurchaseOrderStatus.Delete")]
