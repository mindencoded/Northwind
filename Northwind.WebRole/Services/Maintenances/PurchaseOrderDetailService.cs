...
{
    [RoutePrefix("PurchaseOrderDetails.svc")]
    [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
    public class PurchaseOrderDetailService :
        MaintenanceService<IBusinessUnitOfWork, PurchaseOrderDetail, PurchaseOrderDetailDto>, IPurchaseOrderDetailService
    {
        public PurchaseOrderDetailService(IUnityContainer container) : base(container)
        {
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "PurchaseOrderDetail.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "PurchaseOrderDetail.Insert")]
        public override void Insert(PurchaseOrderDetailDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "PurchaseOrderDetail.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "PurchaseOrderDetail.Delete")]
        ...
        {
            Configure<IPurchaseOrderDetailService>(config, "");
        }
    }
}