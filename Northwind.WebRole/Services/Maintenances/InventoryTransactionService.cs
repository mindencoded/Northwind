...
{
    [RoutePrefix("InventoryTransactions.svc")]
    [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
    public class InventoryTransactionService :
        MaintenanceService<IBusinessUnitOfWork, InventoryTransaction, InventoryTransactionDto>,
        IInventoryTransactionService
    {
        public InventoryTransactionService(IUnityContainer container) : base(container)
        {
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "InventoryTransaction.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "InventoryTransaction.Insert")]
        public override void Insert(InventoryTransactionDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "InventoryTransaction.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "InventoryTransaction.Delete")]
        ...
        {
            Configure<IInventoryTransactionService>(config, "");
        }
    }
}