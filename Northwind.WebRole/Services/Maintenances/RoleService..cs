...
{
    [RoutePrefix("Roles.svc")]
    [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
    public class RoleService : MaintenanceService<ISecurityUnitOfWork, Role, RoleDto>, IRoleService
    {
        public RoleService(IUnityContainer container) : base(container)
        {
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "Role.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "Role.Insert")]
        public override void Insert(RoleDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "Role.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "Role.Delete")]
