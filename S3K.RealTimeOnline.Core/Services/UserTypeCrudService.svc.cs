...
namespace S3K.RealTimeOnline.Core.Services
{
    public class UserTypeCrudService : CrudService<ISecurityUnitOfWork, UserType, UserTypeDto>, IUserTypeCrudService
    {
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudUserType.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudUserType.Insert")]
        public override void Insert(UserTypeDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudUserType.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudUserType.DeleteById")]
        public override void DeleteById(string id)
        {
            base.DeleteById(id);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudUserType.SelectById")]
