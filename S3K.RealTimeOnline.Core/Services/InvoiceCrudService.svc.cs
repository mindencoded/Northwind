...
namespace S3K.RealTimeOnline.Core.Services
{
    public class InvoiceCrudService : CrudService<IBusinessUnitOfWork, Invoice, InvoiceDto>, IInvoiceCrudService
    {
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInvoice.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInvoice.Insert")]
        public override void Insert(InvoiceDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInvoice.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInvoice.DeleteById")]
        public override void DeleteById(string id)
        {
            base.DeleteById(id);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInvoice.SelectById")]
