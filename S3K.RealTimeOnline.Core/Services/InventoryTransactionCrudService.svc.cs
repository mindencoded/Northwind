...
namespace S3K.RealTimeOnline.Core.Services
{
        ...
        IInventoryTransactionCrudService
    {
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInventoryTransaction.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInventoryTransaction.Insert")]
        public override void Insert(InventoryTransactionDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInventoryTransaction.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInventoryTransaction.DeleteById")]
        public override void DeleteById(string id)
        {
            base.DeleteById(id);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInventoryTransaction.SelectById")]
