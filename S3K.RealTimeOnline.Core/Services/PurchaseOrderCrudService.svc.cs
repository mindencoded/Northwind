...
namespace S3K.RealTimeOnline.Core.Services
{
        ...
        IPurchaseOrderCrudService
    {
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudPurchaseOrder.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudPurchaseOrder.Insert")]
        public override void Insert(PurchaseOrderDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudPurchaseOrder.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudPurchaseOrder.DeleteById")]
        public override void DeleteById(string id)
        {
            base.DeleteById(id);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudPurchaseOrder.SelectById")]
