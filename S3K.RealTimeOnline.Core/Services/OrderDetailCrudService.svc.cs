...
namespace S3K.RealTimeOnline.Core.Services
{
        ...
        IOrderDetailCrudService
    {
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudOrderDetail.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudOrderDetail.Insert")]
        public override void Insert(OrderDetailDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudOrderDetail.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudOrderDetail.DeleteById")]
        public override void DeleteById(string id)
        {
            base.DeleteById(id);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudOrderDetail.SelectById")]
