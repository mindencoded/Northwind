...
namespace S3K.RealTimeOnline.Core.Services
{
        ...
        IRoleDetailCrudService
    {
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudRoleDetail.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudRoleDetail.Insert")]
        public override void Insert(RoleDetailDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudRoleDetail.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudRoleDetail.DeleteById")]
        public override void DeleteById(string id)
        {
            base.DeleteById(id);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudRoleDetail.SelectById")]
