...
namespace S3K.RealTimeOnline.Core.Services
{
    public class UserCrudService : CrudService<ISecurityUnitOfWork, User, UserDto>, IUserCrudService
    {
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudUser.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudUser.Insert")]
        public override void Insert(UserDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudUser.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudUser.DeleteById")]
        public override void DeleteById(string id)
        {
            base.DeleteById(id);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudUser.SelectById")]
