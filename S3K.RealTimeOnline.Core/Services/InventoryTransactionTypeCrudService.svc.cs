...
namespace S3K.RealTimeOnline.Core.Services
{
        ...
        IInventoryTransactionTypeCrudService
    {
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInventoryTransactionType.Select")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInventoryTransactionType.Insert")]
        public override void Insert(InventoryTransactionTypeDto dto)
        {
            base.Insert(dto);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInventoryTransactionType.Update")]
        ...
        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInventoryTransactionType.DeleteById")]
        public override void DeleteById(string id)
        {
            base.DeleteById(id);
        }

        [PrincipalPermission(SecurityAction.Demand, Role = "CrudInventoryTransactionType.SelectById")]
