...
namespace Northwind.Shared
{
    public class ColumnInfo
    {
        ...
        [Column("IS_NULLABLE")] public string IsNullable { get; set; }
        ...
        [Column("NUMERIC_PRECISION_RADIX")] public int NumericPrecisionRadix { get; set; }

        [Column("NUMERIC_SCALE")] public int NumericScale { get; set; }

        [Column("DATETIME_PRECISION")] public int DateTimePrecision { get; set; }
    }
}